...
const LOGINBUTTON = ({ onClick, type }: LOGINBUTTON) => {
    return (
        <button type={type} onClick={onClick} style={{ WebkitBoxReflect: 'below 0px linear-gradient(to bottom, rgba(0,0,0,0.0), rgba(0,0,0,0.4))' }} className="px-10 py-3 bg-gradient-to-r from-sky-500 to-blue-500 rounded-full shadow-xl group-hover:shadow-2xl group-hover:shadow-sky-600 shadow-sky-600 uppercase font-serif tracking-widest relative overflow-hidden group text-transparent cursor-pointer z-10 after:absolute after:rounded-full after:bg-sky-200 after:h-[85%] after:w-[95%] after:left-1/2 after:top-1/2 after:-translate-x-1/2 after:-translate-y-1/2 hover:saturate-[1.15] active:saturate-[1.4]">
            ...
            <p className="absolute z-40 top-1/2 left-1/2 bg-gradient-to-r from-sky-700 to-blue-700 bg-clip-text text-transparent -translate-x-1/2 translate-y-full h-full w-full transition-all duration-300 group-hover:-translate-y-[40%] tracking-widest font-extrabold">
                LogIn
            </p>
            <svg className="absolute w-full h-full scale-x-125 rotate-180 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-30 group-hover:animate-none animate-pulse group-hover:-translate-y-[45%] transition-all duration-300" viewBox="0 0 2400 800" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" xmlns="http://www.w3.org/2000/svg">
                <defs>
                    <linearGradient id="sssurf-grad" y2="100%" x2="50%" y1="0%" x1="50%">
                        <stop offset="0%" stopOpacity={1} stopColor="hsl(217, 91.80%, 80.80%)" />
                        <stop offset="100%" stopOpacity={1} stopColor="hsl(196, 69.20%, 56.70%)" />
                    </linearGradient>
                </defs>
            ...
            <svg className="absolute w-full h-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-[30%] group-hover:-translate-y-[33%] group-hover:scale-95 transition-all duration-500 z-40 fill-sky-500" viewBox="0 0 1440 320" xmlns="http://www.w3.org/2000/svg">
